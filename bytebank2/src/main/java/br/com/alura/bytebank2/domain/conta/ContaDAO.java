...
import br.com.alura.bytebank2.domain.cliente.Cliente;
...
public class ContaDAO {
    ...
    public void salvar(DadosAberturaConta dadosDaConta) {
        ...
        String sql = "INSERT INTO conta(numero, saldo, cliente_nome, cliente_nome, cliente_cpf, cliente_email)" + "VALUES(?,?,?,?,?)";
